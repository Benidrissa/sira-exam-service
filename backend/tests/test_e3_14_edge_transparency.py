...
def test_admin_metrics_returns_expected_keys() -> None:
    ...
    expected_keys = {
        "total_snapshots", "edge_classified", "edge_coverage_pct",
        "edge_fn_rate_pct", "edge_clean", "false_negatives", "model_version_distribution",
    }
    # Construct a mock response and verify keys
    mock_response = {
        "total_snapshots": 100, "edge_classified": 80, "edge_coverage_pct": 80.0,
        "edge_fn_rate_pct": 2.5, "edge_clean": 75, "false_negatives": 2,
